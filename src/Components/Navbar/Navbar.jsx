...
import underline2 from '../../assets/underline.jpg'
...
const Navbar = () => {
  ...
  const menuRef=useRef();
   ...
   const closeMenu=()=>{
   menuRef.current.style.right="-350px";// img src={underline2} alt='line'/>
   }
  ...
  return (
    <div className="navbar">
        ...
        <ul ref={menuRef}  className="nav-menu">
            ...
            <li><AnchorLink className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>Porfolio</p></AnchorLink>{menu==="work"?<hr/>:<></>}</li>
